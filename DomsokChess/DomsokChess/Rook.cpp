...
Rook::Rook(Piece_color piece_color) :
	Figure(piece_color)
{
}

Piece_types Rook::get_type() const
{
	return Piece_types::Rook;
}
void Rook::print_figure()
{
...
std::vector<FieldDescriptor> Rook::get_available_moves(FieldDescriptor from_field, Board const* board) const
{
...
bool Rook::check_move(FieldDescriptor from_field, FieldDescriptor to_field, Board const* board, Piece_color c_player) const
{
...
std::vector<FieldDescriptor> Rook::get_available_attacks(Board const* board, FieldDescriptor from_field) const
{
...
bool Rook::check_attack(Board const* board, FieldDescriptor from_field, FieldDescriptor to_field, Piece_color c_active_player) const
{
...
bool Rook::check_type(char c)const
{
	return c == 'R';
}